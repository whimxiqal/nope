...
public class PlayerOrPlayerUUID extends CommandElement {
  ...
  @Nullable
  @Override
  protected CompletableFuture<GameProfile> parseValue(CommandSource source, CommandArgs args) throws ArgumentParseException {
    ...
    if (uuid == null) {
      uuid = Sponge.getServer().getPlayer(arg)
          ...
          .orElseThrow(() -> new ArgumentParseException(Text.of("Player not online or uuid invalid!"), arg, 0));
    }
